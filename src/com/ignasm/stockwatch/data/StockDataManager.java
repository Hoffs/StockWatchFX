...
public class StockDataManager {
    ...
    public static StockEntry[] getSavedStockActivityEntries() {
        ...
        try {
            ...
            LinkedList<StockEntry> activityList = new LinkedList<>();
            while(resultSet.next()) {
                Stock stock = new Stock(resultSet.getInt("s_id"), resultSet.getString("company_name"), resultSet.getString("symbol"));
                activityList.add(new StockEntry(resultSet.getInt("sa_id"), resultSet.getDouble("share_change"), resultSet.getDouble("net_change"), stock));
            }
            data = activityList.toArray(new StockEntry[activityList.size()]);
    ...
    public static Stock[] getSavedStocks() {
    ...
    public static void insertNewStockActivity(StockEntry stockEntry) {}
